...
def load_tilde_expansion(filepath):
    logging.info("Loading m=200 expansions for TILDE...")
    expansions = {}
...
def main():
    ...
    parser.add_argument("--tilde_filepath", type=str, required=True)
    parser.add_argument("--dataset", type=str, required=False)
    parser.add_argument("--model_name_or_path", type=str, default="ielab/unicoil-tilde200-msmarco-passage")
    ...
    tilde_filepath = args.tilde_filepath
    ...
    expansions = load_tilde_expansion(tilde_filepath)
    ...
    with open(output_corpus, 'w') as fOut:
        for doc_id in tqdm.tqdm(corpus, total=len(corpus)):
            ...
            expansion = expansions[doc_id]["psg"]
