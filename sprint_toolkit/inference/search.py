...
def define_search_args(parser):
    ...
    parser.add_argument(
        "--ckpt_name", type=str, default=None, help="encoder ckpt name or path"
    )
    parser.add_argument(
        "--min-idf",
        type=int,
    ...
    parser.add_argument(
        "--bm25", action="store_true", default=True, help="Use BM25 (default)."
    )
    ...
    parser.add_argument(
        "--language",
        type=str,
        help="language code for BM25, e.g. zh for Chinese",
        default="en",
    )
    ...
    parser.add_argument(
        "--stopwords", type=str, help="Path to file with customstopwords."
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--output", type=str, metavar="path", help="Path to output file."
    )
    parser.add_argument(
        "--max-passage",
        action="store_true",
    ...
    parser.add_argument(
        "--tokenizer", type=str, help="tokenizer used to preprocess topics"
    )
    parser.add_argument(
        "--remove-duplicates",
        action="store_true",
        default=False,
        help="Remove duplicate docs.",
    )
